...
**Status:** built + hardware-validated on `fix/flash-log-durability` · **Target:** `firmware/shintai-os/shintai-os.ino` · **Seam:** [CONTRACT.md](../../CONTRACT.md) (no change) · **Date:** 2026-07-02
