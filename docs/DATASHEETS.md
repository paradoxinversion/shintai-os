...
| **Adafruit Ultimate GPS** (MTK3339) | GPS fix / NMEA | `Adafruit_GPS` — https://github.com/adafruit/Adafruit_GPS | https://www.adafruit.com/product/746 | https://learn.adafruit.com/adafruit-ultimate-gps · [MTK3339 datasheet](https://cdn-shop.adafruit.com/datasheets/GlobalTop-FGPMMOPA6H-Datasheet-V0A.pdf) |
