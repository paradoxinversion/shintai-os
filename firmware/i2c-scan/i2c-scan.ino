...
const KnownDev KNOWN[] = {
  ...
  {0x39, "APDS9960 gesture   [spine] << Andon LED Matrix ships here too — readdress the matrix off 0x39 (0x72 is its 8-bit form) so it lands at 0x3F"},
  {0x3C, "OLED (SSD1306/SH1106) [phase1, output] (128x32 default; alt 0x3D)"},
  {0x3F, "Andon LED Matrix   [output] (Modulino ABX00152, readdressed off its 0x39 default)"},
